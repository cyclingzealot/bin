...
base_dir=$HOME/backups/file_list/
mkdir -p $base_dir

target_file=$base_dir/file_list.`ts.bash`.gz

find $HOME | gzip -9 > $target_file || true

ls -lh $target_file

find $base_dir -type f -mtime +30 -iname 'file_list.*.gz' -exec rm -v {} \;
